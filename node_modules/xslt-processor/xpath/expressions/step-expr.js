...
var StepExpr = /** @class */ (function (_super) {
    ...
    StepExpr.prototype.evaluate = function (context) {
        var input = context.nodeList[context.position];
        var nodeList = [];
        ...
        switch (this.axis) {
                ...
                if (this.nodeTest.name != undefined) {
                    ...
                    if (input.attributes) {
                        if (input.attributes instanceof Array) {
                            ...
                            (0, common_function_1.copyArray)(nodeList, input.attributes);
                        }
                        else {
                            if (this.nodeTest.name == 'style') {
                                var value = input.getAttributeValue('style');
                    ...
                    if (context.ignoreAttributesWithoutValue) {
                        (0, common_function_1.copyArrayIgnoringAttributesWithoutValue)(nodeList, input.attributes);
                    }
                    else {
                        (0, common_function_1.copyArray)(nodeList, input.attributes);
                    }
            ...
            case tokens_1.xPathAxis.CHILD:
                (0, common_function_1.copyArray)(nodeList, input.childNodes);
                break;
